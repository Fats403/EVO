...
{
    Infection, // Stacks infected, deals 1 damage each round, clears one stack at end of round
    Shield, // Stacks shielded, negates next damage, clears one stack at end of round
    Reflect, // Stacks reflect, reflects next damage, clears one stack at end of round
    Fatigue, // Stacks fatigue, reduces speed by number of stacks each round, clears one stack at end of round
...
public static class StatusTagGroups
{
    public static readonly StatusTag[] Negative = new StatusTag[]
    {
        StatusTag.Infection,
        StatusTag.Fatigue,
        ...
        StatusTag.NoForage,
        StatusTag.Bleed,
        StatusTag.Malnourish,
    };

    public static readonly StatusTag[] Positive = new StatusTag[]
    {
        StatusTag.Shield,
        StatusTag.Reflect,
        StatusTag.DamageUp,
